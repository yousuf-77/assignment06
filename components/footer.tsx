          ...
          <div className="h-[261px] flex-col  xs:h-[82px] w-full xs:flex-row flex justify-between  items-center ">
            ...
            <div className="w-full xs:w-[35.714%] max-w-[400px] md:min-w-[390px] md:h-full h-[146px] flex flex-col justify-between gap-1">
              <div className="w-full h-[112px] md:h-[48px] md:flex-row flex-col flex justify-between items-center">
                <input type="email" name="email" id="email" placeholder="Enter your email" className="w-full md:w-[265px] h-auto p-[12px] gap-[8px] rounded-[5px] border border-black placeholder-[#505050] "/>
                <button className="w-full md:w-[119px] md:h-full` py-[12px] rounded-[5px] border border-black text-center text-[16px] font-normal leading-[24px] ">Subscribe</button>
              </div>
              <p className="text-[12px] font-normal leading-[18px] text-center xs:text-left">By subscribing you agree to with our <span className="text-[12px] font-normal leading-[18px] text-left underline underline-solid"> Privacy Policy </span></p>
            </div>
          </div>
          ...
          <div className="h-[147px] xs:h-[57px] w-full border-t border-t-black flex justify-center items-end">
            <div className="h-[114px] xs:h-[24px] w-full flex justify-between items-center xs:flex-row flex-col">
              <div className="w-full xs:w-[50.357%] max-w-[564px] md:min-w-[524px] h-full flex justify-around xs:justify-between items-center xs:min-w-[307px]  flex-wrap">
                <p className=" w-full md:w-auto text-[14px] font-normal leading-[21px] text-center xs:text-left">2023 Ddsgnr. All right reserved.</p>
